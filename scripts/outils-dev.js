...
window.detailData['outils-dev'] = {
  title: 'Outils — Développement',
  html: '\
        <div class="detail-section">\
          <h4>Présentation</h4>\
          <p>Outils utilisés au quotidien pour le développement, la gestion de versions et les environnements de travail.</p>\
        </div>\
        <div class="detail-section">\
          ...
          <ul>\
            ...
            <li><strong>PyCharm</strong> — IDE pour développement Python, gestion de projets, intégration Git.</li>\
            <li><strong>DataSpell</strong> — IDE pour data science, notebooks Jupyter, analyse de données.</li>\
          </ul>\
        </div>\
        <div class="detail-section">\
          ...
          <ul>\
            ...
            <li><strong>SQLite</strong> — Base de données légère pour projets embarqués.</li>\
          </ul>\
        </div>\
        <div class="detail-section">\
