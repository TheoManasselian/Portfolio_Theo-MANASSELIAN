...
window.detailData['outils-systemes'] = {
  title: 'Outils — Systèmes - Logiciels - Réseaux',
  html: '\
        <div class="detail-section">\
          <h4>Présentation</h4>\
          <p>Outils utilisés pour la virtualisation, la simulation réseau et l\'administration système.</p>\
        </div>\
        <div class="detail-section">\
          ...
          <ul>\
            ...
            <li><strong>Windows Server</strong> — DHCP, DNS, AD DS, partages réseau, gestion de rôles.</li>\
            <li><strong>Linux</strong> — Administration en ligne de commande, gestion de services, permissions.</li>\
          </ul>\
        </div>\
        <div class="detail-section">\
          ...
          <ul>\
            ...
            <li><strong>VirtualBox</strong> — Logiciel de virtualisation open-source.</li>\
            <li><strong>Proxmox</strong> — Solution de virtualisation open-source.</li>\
          </ul>\
        </div>\
        <div class="detail-section">\
        ...
        <div class="detail-section">\
          ...
          <ul>\
            ...
            <li><strong>GNS3</strong> — Plateforme de simulation de réseaux avancée.</li>\
          </ul>\
        </div>\
        <div class="detail-section">\
          <h4>Virtualisation</h4>\
        ...
        <div class="detail-section">\
          ...
          <p class="clickable detail-project-link" data-detail="projet-reseau">→ Projet Virtualisation – Réseau Packet Tracer – VM Windows Server</p>\
          <p>(Cisco Packet Tracer, VMware)<p>\
        </div>\
      '
};
